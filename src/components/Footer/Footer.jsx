...
function Footer() {
  const [footerItems, setFooterItems] = useState([
    ...
    },
    {
      ...
      caption: "پشتیبانی حرفه ای",
      element: (
        <svg height="50" viewBox="0 0 511.987 511.987" width="50">
          <g>
            <g>
              <path
  ...
  const [footerList, setFooteList] = useState([
    {
      id: 1,
      title: "با نگارشاپ",
      listItem: "اتاق خبر نگارشاپ",
      type: "listOne",
    },
    { id: 2, listItem: "فروش در نگارشاپ", type: "listOne" },
    { id: 3, listItem: "همکاری با سازمان‌ها", type: "listOne" },
    { id: 4, listItem: "فرصت‌های شغلی", type: "listOne" },
    {
      id: 5,
      title: "خدمات مشتریان",
      listItem: "پاسخ به پرسش‌های متداول",
      type: "listTwo",
    },
    { id: 6, listItem: "رویه‌های بازگرداندن کالا", type: "listTwo" },
    { id: 7, listItem: "شرایط استفاده", type: "listTwo" },
    { id: 8, listItem: "حریم خصوصی", type: "listTwo" },
    {
      id: 9,
      title: "راهنمای خرید از نگارشاپ ",
      listItem: "نحوه ثبت سفارش",
      type: "listThree",
    },
    { id: 10, listItem: "رویه ارسال سفارش", type: "listThree" },
    { id: 11, listItem: "شیوه‌های پرداخت", type: "listThree" },
  ]);

  return (
    <footer className="footer bg-white mt-12">
      <svg
        className="hidden sm:block w-[200%] h-24"
      ...
      <div className="container pt-14">
        ...
        <div className="pt-12 sm:pt-14 text-center sm:text-right flex justify-between flex-wrap">
          <ul className="flex flex-col w-full sm:w-1/2 lg:w-1/5 mb-4">
            {footerList
              .filter((list) => list.type === "listOne")
              .map((item) => (
          ...
          <ul className="flex flex-col w-full sm:w-1/2 lg:w-1/5 mb-4">
            {footerList
              .filter((list) => list.type === "listThree")
              .map((item) => (
                <FooterList key={item.id} {...item} />
              ))}
          </ul>

          <div className="w-full sm:w-1/2 lg:max-w-[22rem] lg:mr-auto mb-4">
            <h6 className="text-[15px] text-[#474646]">خبرنامه</h6>
            <p className="text-sm my-3 text-[#757575]">
              با عضویت در خبرنامه از آخرین اخبار و محصولات سایت مطلع شوید...
            </p>
            <div className="flex justify-center sm:justify-start">
              <input
                className="bg-[#f5f5f5] focus:outline-none text-sm p-[10px] rounded-[20px] w-[70%] sm:w-auto placeholder:text-sm focus:bg-white focus:shadow-[0_2px_5px_rgba(0,0,0,0.1)]"
                placeholder="آدرس ایمیل"
              />
              <button
                type="submit"
                className="bg-[#757575] text-white p-2 mr-3 text-sm rounded-[20px]"
              >
                عضوم کن
              </button>
            </div>
      ...
      <hr />
      <div className="container py-4 mb-12 lg:mb-0">
        <p className=" text-center text-[#474646] text-[15px] select-none">
