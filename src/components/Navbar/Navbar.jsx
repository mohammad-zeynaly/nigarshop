        ...
        <nav className="mt-6">
            <div className="container">
                <div className="flex flex-row-reverse lg:flex-row justify-between items-center">
                    <span className="lg:hidden cursor-pointer" onClick={() => setStatusMenu(prev => !prev)}>
                        {statusMenu ? (
                ...
                <ul className={`flex flex-col lg:hidden bg-white fixed top-0 z-20 ${statusMenu ? 'right-0' : 'right-[-260px]'} w-[260px] bottom-0 py-5 transition-all duration-200`}>
