      ...
      <div className="container">
        <div className="flex justify-between items-center">
          ...
          <div className="w-[35rem] flex items-center relative">
            <input
              className="py-4 px-4 focus:border-none focus:outline-none rounded-[20px] font-iranSansRegular text-sm w-full"
              type="text"
          ...
          <div className="flex items-center">
            <span className="text-[#666] text-sm ml-3 font-iranSansBold">
              حساب کاربری
            </span>
            <Link
              to="/myAccount"
              className="bg-[#dedede] p-[14px] rounded-[20px] group hover:bg-primary"
            >
