    ...
    <>
      <div className="flex flex-col bg-white rounded-[20px]">
        ...
        <div className="max-w-[16rem] mx-auto text-center">
          ...
          >
            <h4 className="text-sm font-iranSansBold overflow-hidden text-ellipsis whitespace-nowrap mt-3">
              {name}
            </h4>
          </Link>
          <span className="text-primary block mt-2 font-iranSansBold text-sm">
            {persian.format(price)} تومان
          </span>
        </div>
