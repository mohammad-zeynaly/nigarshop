...
function MyAccount () {
    ...
    const formItems = [
        ...
        },
        {
            ...
            labelOne:"آدرس ایمیل",
            labelTwo:'گذرواژه',
            security:"اطلاعات شخصی شما نزد ما نگهداری میشود و به هیچ عنوان سوءاستفاده نخواهد شد.",
            ...
            <div className="container">
                <div className="flex flex-col items-center mt-6 lg:mt-12">
                    <Link className="w-32" to="/">
                        <img className="w-full object-cover " src="./assets/images/negarshop-logo.png" alt="لوگو فروشگاه"/>
                    </Link>
